...
def get_batch_ids(url, token, batch_type="pg_pv_Batch"):
    query = {
        'required': {
            'data': '*'
        },
...
def get_ids_in_batch(url, token,batch_ids, batch_type="pg_pv_Batch"):
    query = {
        'required': {
            'data': '*'
        },
...
def get_all_JV(url, token, sample_ids, jv_type="pg_pv_JVmeasurement"):
    # collect the results of the sample, in this case it are all the annealing temperatures
...
def get_all_eqe(url, token, sample_ids, eqe_type="pg_pv_EQEmeasurement"):
    #
    query = {
        'required': {
            'metadata': '*'
...
def get_all_mppt(url, token, sample_ids, mppt_type="pg_pv_SimpleMPPTracking"):
    #
    query = {
        'required': {
            'metadata': '*'
